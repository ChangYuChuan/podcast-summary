...
_DEFAULT_DETAIL_TEMPLATE_ZH = (
    ...
    "  • 技術面 / 籌碼面：1–3 點，若資料中有提到價量、外資 / 投信動向、技術指標等。\n"
    "  • 風險與需要關注的因素：1–3 點，包含產業風險、競爭、政策、總體環境等中性描述的不確定性。\n"
    "  • 關鍵數字或近期催化劑：列出具體的數據、日期、價位、財報時點等資訊；若資料來源中沒有具體數字，請寫「資料來源未提供具體數字」。\n\n"
    "重要：本筆記為客觀整理，**不要**寫出主觀的投資建議或定調，"
